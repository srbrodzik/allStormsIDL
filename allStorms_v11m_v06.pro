pro allStorms_v11m_v06,year=year,month=month,region=region

  ;;.r /home/disk/shear2/brodzik/IDL/gpm/allStorms/OceanRuns/allStorms_sam_v11m_v06

  ;;allStorms_sam_v11m_v06,type='03_2014_SAM'
  ...
  for ff=0l,countNfiles-1 do begin
     ...
     print,'analyzing '+region+' region with allStorms_v11m_v06 for orbit='+orbit+' datetime='+datetime+$
     ...
     if cta_refl_ge_0 gt 2 then begin
        ...
        print,'Id-Stratiform'
        ;;*******************
        stra_class,id_storm,npix_str,grid_storm,num_storm
        
        ;;*******************
        print,'Id-Convective'
        ;;*******************
        conv_class,id_storm,npix_str,grid_storm,num_storm
        
        if SH_CALCS then begin
           ;;*********************
           print,'Id-Shallow Isol'
           ;;*********************
           shal_iso_class,id_storm,npix_str,grid_storm,num_storm
        endif
  ...
  output_monthly_class_data,path_out,year,month,region,SH_CALCS
  output_nsr_data,path_out,year,month,region,SH_CALCS       ;; needs mods to 7th element of .rain output
  output_raccum_data,path_out,year,month,region,SH_CALCS    ;; needs mods to both core and full
  output_cfad_data,path_out,year,month,region,SH_CALCS      ;; needs mods to both core and full
  ;;*********************************************************************************************************************
